...
-- AddForeignKey
ALTER TABLE "EncryptedPrescriptionData" ADD CONSTRAINT "EncryptedPrescriptionData_prescriptionId_fkey" FOREIGN KEY ("prescriptionId") REFERENCES "Prescription"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
